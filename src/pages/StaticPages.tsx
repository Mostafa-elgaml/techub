          ...
          <div className="prose prose-lg max-w-none">
            {language === 'ar' ? (
              <>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  بالإضافة إلى بيع الأجهزة، نوفر مجموعة شاملة من خدمات الصيانة والدعم الفني، بما في ذلك إصلاح العتاد، إصلاح اللوحات الأم، الدعم البرمجي، وعقود الدعم الفني للشركات.
                </p>
